    ...
    <Row className="justify-content-center">
      <Col lg={10}>
        ...
        <p style={{ fontSize: "1.1rem", lineHeight: 1.7, color: "#111" }}>
          ...
          We work exclusively with rarity natural diamonds so you can cherish the timeless beauty. We have over 18 years of experience in the diamond business, specializing in both diamonds and craftsmanship.
          <br /><br />
